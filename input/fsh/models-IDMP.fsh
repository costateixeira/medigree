...
* identifier 0..* BackboneElement "Identifiers" "Identifiers"
  * l1_identifier 0..1 Identifier "Business identifier for this medication" "Business identifier for this medication"
  * l2_identifier 0..1 Identifier "Business identifier for this medication" "Business identifier for this medication"
  * l3_identifier 0..1 Identifier "Business identifier for this medication" "Business identifier for this medication"
  * l4_identifier 0..1 Identifier "Business identifier for this medication" "Business identifier for this medication"
